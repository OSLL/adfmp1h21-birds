...
import kotlinx.android.synthetic.main.fragment_profile_demo_logged_in.*
...
class ProfileDemoLoggedIn : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = ProfileDemoLoggedIn()
    }
}
